    ...
    <div class="StrCPVisits_main-wrapper">
        ...
        <div class="StrCPVisits-light-tabs" data-active-class="StrCPVisits-form-tab-active">
            ...
            <div class="StrCPVisits-form-tab">
              ...
              <?php require_once( dirname(__FILE__) . '/template-parts/documentation-tab.php' ); ?>
            </div>
            ...
            <div class="StrCPVisits-form-tab">
              ...
              <?php require_once( dirname(__FILE__) . '/template-parts/screenshot-tab.php' ); ?>
            </div>
            ...
            <div class="StrCPVisits-form-tab">
              ...
              <?php require_once( dirname(__FILE__) . '/template-parts/installation-tab.php' ); ?>
            </div>
            ...
            <div class="StrCPVisits-form-tab">
              ...
              <?php require_once( dirname(__FILE__) . '/template-parts/debugging-tab.php' ); ?>
            </div>
            ...
            <div class="StrCPVisits-form-tab">
              ...
              <?php require_once( dirname(__FILE__) . '/template-parts/faq.php' ); ?>
            </div>
            ...
            <div class="StrCPVisits-form-tab">
              ...
              <?php require_once( dirname(__FILE__) . '/template-parts/about-tab.php' ); ?>
            </div>
